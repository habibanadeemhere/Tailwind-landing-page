...
const Footer = () => {
  return (
    <>
   <section className="footer w-full text-left">

<div className="foot flex flex-col md:flex-row flex-wrap justify-between mt-5 items-start gap-10 md:gap-24 text-[#787878] bg-[#232323] px-6 md:px-16 py-10 text-left">
