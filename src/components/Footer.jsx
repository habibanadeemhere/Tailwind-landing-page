...
const Footer = () => {
  return (
    <section className="w-full bg-[#232323] overflow-hidden">
      <div className="w-full flex flex-col md:flex-row justify-between items-start gap-10 text-[#787878] px-10 md:px-24 py-12">
