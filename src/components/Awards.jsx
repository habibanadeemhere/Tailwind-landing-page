...
const Awards = () => {
  return (
    <section className="awards mt-10">
      ...
      <div className="cards flex justify-center gap-14 mt-10 flex-wrap md:flex-row">
        <div className="h-64 w-64 bg-[#FFF5F3] text-center rounded-md">
          <img className='mx-auto mb-4 mt-7' src={Card1} alt="" />
          <b>Market leader across 18 categories</b>
        </div>
        <div className="h-64 w-64 bg-[#FFF0F9] text-center rounded-md">
          <img className='mx-auto mb-4 mt-7' src={Card2} alt="" />
          <b>Most loved SaaS tool <br /> in 2021</b>
        </div>
        <div className="h-64 w-64 bg-[#ECFFFF] text-center rounded-md">
          <img className='mx-auto mb-4 mt-7' src={Card3} alt="" />
          <b>Category leader in <br /> 2022</b>
        </div>
      </div>

      <div className="cards flex justify-center gap-14 mt-5 flex-wrap md:flex-row">
        <div className="h-64 w-64 bg-[#F6F4FF] text-center rounded-md">
          <img className='mx-auto mb-4 mt-7' src={Card4} alt="" />
          <b>Most recommended <br /> tool in 2021</b>
        </div>
        <div className="h-64 w-64 bg-[#FFF9E7] text-center rounded-md">
          <img className='mx-auto mb-4 mt-7' src={Card5} alt="" />
          <b>Champion in survey <br /> tool 2022</b>
        </div>
        <div className="h-64 w-64 bg-[#FFEDE4] text-center rounded-md">
